...
// Função auxiliar para verificar se diretório existe (compatível com C++11)
...
// Função auxiliar para criar diretório (Windows)
...
// Função auxiliar para obter caminho do diretório data
